...
static void SaveCommandLine(int argc, char **argv)
{
   ...
   __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "argv:", 1);
   __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, argv, 1);
   __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "argc:", 1);
   __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "%d", argc, 1);
   for (i=0;i<argc;i++)
   {
      __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "argv[%d]:", i, 1);
      __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, argv[i], 1);
      __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "%d", i, strlen(argv[i]), 1);
      len+=strlen(argv[i])+1;
   }
