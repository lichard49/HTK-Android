...
int gogogo(int argc, char *argv[])
{
   ...
   __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "Start init", 1);
   ...
   __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "Done init", 1);
   ...
   __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "DONEEEEE", 1);

   //Exit(0);
   return 123456789;          /* never reached -- make compiler happy */
}
